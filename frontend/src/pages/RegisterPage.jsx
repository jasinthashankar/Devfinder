    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[var(--color-bg)] px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6 shadow-xl">
          <h1 className="text-center text-lg font-semibold text-[var(--color-text)] mb-5">Create account</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="username" className="block text-xs text-[var(--color-text-muted)] mb-1.5">
                Username
              </label>
              <input
                id="username"
          ...
          <p className="text-center text-xs text-[var(--color-text-muted)] mt-5">
            ...
            <Link to="/login" className="text-[var(--color-accent-bright)] hover:underline">
              Log in
            </Link>
          </p>
        </div>
